...
from models import swin_c_multibatch as swin
    ...
    def train_eopch(self):
        ...
        for step, (inputs, points, targets, st_sizes) in enumerate(self.dataloaders['train']):
            ...
            with torch.set_grad_enabled(True):
                ...
                for feature in features:  # [batch, tokens, channels]
                    mean_feature = feature.mean(dim=1, keepdim=True)
                    cosine = 1 - F.cosine_similarity(
                        feature, mean_feature.expand_as(feature), dim=-1, eps=1e-5
                    )
