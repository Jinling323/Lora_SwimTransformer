...
class LearnableGlobalLocalMultiheadAttention(nn.Module):
    ...
    def __init__(
        ...
        self.in_proj_weight = Parameter(torch.empty(self.NUM_WEIGHTS * embed_dim, embed_dim))
        self.in_proj_bias = Parameter(torch.empty(self.NUM_WEIGHTS * embed_dim))
    ...
    def forward(self, query, key, shape, value):
        ...
        local_att_mask = local_att_mask.contiguous().view(
